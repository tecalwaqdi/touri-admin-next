...
import type { GeographyCityListItem } from "@/application/geography/geographyListDtos";
                ...
                <tr key={row.cityId} className="border-t border-slate-100">
                  ...
                  <td className="px-4 py-3">
                    <GeographyLandmarksCountCell
                      count={row.landmarksCount}
                      locale={locale}
                      testId={`city-landmarks-count-${row.cityId}`}
                    />
                  </td>
                  <td className="px-4 py-3">
