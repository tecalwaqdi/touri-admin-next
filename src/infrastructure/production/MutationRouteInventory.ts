...
export const ADMIN_NEXT_MUTATION_ROUTE_INVENTORY: MutationRouteInventoryRow[] = [
  ...
  {
    method: "POST",
    path: "/api/drivers/[id]/approve",
    classification: "mutation",
    domain: "drivers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated; Fake offline only until Production arms false",
  },
  {
    method: "POST",
    path: "/api/drivers/[id]/reject",
    classification: "mutation",
    domain: "drivers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated driver reject",
  },
  {
    method: "POST",
    path: "/api/drivers/[id]/needs_changes",
    classification: "mutation",
    domain: "drivers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated driver needs_changes",
  },
  {
    method: "POST",
    path: "/api/drivers/[id]/suspend",
    classification: "mutation",
    domain: "drivers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated driver suspend",
  },
  {
    method: "POST",
    ...
    domain: "agents",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated; one-country-one-active-agent",
  },
  {
    method: "POST",
    ...
    domain: "agents",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated agent deactivate",
  },
  {
    method: "POST",
    path: "/api/agents/[id]/suspend",
    classification: "mutation",
    domain: "agents",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated agent suspend",
  },
  {
    method: "POST",
    path: "/api/customers/[id]/disable",
    classification: "mutation",
    domain: "customers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated customer disable",
  },
  {
    method: "POST",
    ...
    domain: "customers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated customer block",
  },
  {
    method: "POST",
    ...
    domain: "customers",
    shadowBehavior: "reject_production_write",
    notes: "PC-9 gated customer reactivate",
  },
  {
    method: "POST",
    ...
    domain: "agents",
    shadowBehavior: "reject_production_write",
    notes: "Legacy activate route; Production → PRODUCTION_WRITE_DISABLED",
  },
  {
    method: "GET",
    path: "/api/dashboard",
