    ...
    let items = result.docs
      ...
      .map((d) => {
        ...
        const model: CanonicalCountryReadModel = {
          ...
          activeStatus: mappedCountry.activeStatus,
          imagePresence: mappedCountry.imagePresence,
          imageStorageKind: mappedCountry.imageStorageKind,
          currencySymbol: mappedCountry.currencySymbol,
  ...
  async listCities(
    ...
    for (const d of result.docs) {
      ...
      const model: CanonicalCityReadModel = {
        ...
        imagePresence: cityBiz.imagePresence,
        imageStorageKind: cityBiz.imageStorageKind,
    ...
    let items = result.docs
      ...
      .map((d) => {
        ...
        const model: CanonicalRegionReadModel = {
          ...
          imagePresence: mapped.imagePresence,
          imageStorageKind: mapped.imageStorageKind,
          source: mapped.source,
