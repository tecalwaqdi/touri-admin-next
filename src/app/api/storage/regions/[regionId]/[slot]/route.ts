...
import { readRegionImage } from "@/application/storage/ReadCountryRegionImage";
...
export async function GET(
  request: Request,
  context: { params: Promise<{ regionId: string; slot: string }> },
) {
  try {
    ...
    const result = await readRegionImage(
    ...
    return new Response(result.body as BodyInit, {
      headers: {
        ...
        "Content-Disposition": 'inline; filename="region-image"',
