...
import { readCountryImage } from "@/application/storage/ReadCountryRegionImage";
...
export async function GET(
  request: Request,
  context: { params: Promise<{ countryId: string; slot: string }> },
) {
  try {
    ...
    const result = await readCountryImage(
    ...
    return new Response(result.body as BodyInit, {
      headers: {
        ...
        "Content-Disposition": 'inline; filename="country-image"',
