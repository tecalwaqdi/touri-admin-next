...
import { readCityImage } from "@/application/storage/ReadCityImage";
...
export async function GET(
  request: Request,
  context: { params: Promise<{ cityId: string; slot: string }> },
) {
  try {
    ...
    const result = await readCityImage(
    ...
    return new Response(result.body as BodyInit, {
      headers: {
        ...
        "Content-Disposition": 'inline; filename="city-image"',
