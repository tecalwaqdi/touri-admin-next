...
import { getProductionCityDetailApi } from "@/application/production-read/ProductionGeographyApiReads";
...
/** GET /api/geography/cities/[id] — WIF-native city detail (read-only). */
export async function GET(
  ...
  try {
    ...
    const detail = await getProductionCityDetailApi(ctx, id);
