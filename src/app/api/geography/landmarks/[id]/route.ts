...
import { getProductionLandmarkDetailApi } from "@/application/production-read/ProductionGeographyApiReads";
...
/** GET /api/geography/landmarks/[id] — WIF-native landmark detail (read-only). */
export async function GET(
  ...
  try {
    ...
    const detail = await getProductionLandmarkDetailApi(ctx, id);
