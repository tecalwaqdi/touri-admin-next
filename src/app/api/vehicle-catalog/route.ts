...
import { listVehicleTypes } from "@/application/production-read/P0CatalogApiReads";

/** GET /api/vehicle-catalog — Legacy type_car master. */
export async function GET(request: Request) {
  ...
  try {
    ...
    const result = await listVehicleTypes(client, {
