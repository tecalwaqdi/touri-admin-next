...
import { listTourGuides } from "@/application/production-read/P0CatalogApiReads";

/** GET /api/guides — tour guide personas on user. */
export async function GET(request: Request) {
  ...
  try {
    ...
    const result = await listTourGuides(client, {
