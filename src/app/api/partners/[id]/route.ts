...
import { getPartnerLandmark } from "@/application/production-read/P0CatalogApiReads";

/** GET /api/partners/[id] — partner landmark detail. */
export async function GET(
  ...
  try {
    ...
    const result = await getPartnerLandmark(client, id);
    if (!result) {
