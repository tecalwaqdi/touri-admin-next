...
function mapCityListItem(
  ...
  return {
    ...
    displayNameAr,
    displayNameEn,
    descriptionAr: model.descriptionAr ?? null,
    descriptionEn: model.descriptionEn ?? null,
    countryId: model.countryId || null,
...
function mapLandmarkListItem(
  ...
  return {
    ...
    isMosque: model.isMosque ?? null,
    isFood: model.isFood ?? null,
    isRestroom: model.isRestroom ?? null,
    asAds: model.asAds ?? null,
